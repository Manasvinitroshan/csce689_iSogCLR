...
def main(args):
    ...
    model = CLIP(image_encoder=args.image_encoder, text_encoder=args.text_encoder, embed_dim=args.embed_dim, init_model=args.init_model, bsz=args.batch_size_train*args.world_size,
                  ...
                  use_temp_net=args.isogclr_temp_net, alpha=args.alpha, distributed=args.distributed, topk=args.topk)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--topk', default=5, type=int, help='Top-K for GCL-TopK')
